# <img src="https://pancsta.github.io/assets/asyncmachine-go/logo.png" height="25"/> /examples/benchmark_state_source
...
Benchmark of [`/examples/tree_state_source`](/examples/tree_state_source) using [go-wrk](https://github.com/tsliwowicz/go-wrk)
