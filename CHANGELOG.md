...
- feat\(machine\): add `Machine.Fork` and `Machine.Go` sugar [\#358](https://github.com/pancsta/asyncmachine-go/pull/358)
 (@pancsta)
- feat\(am-vis\): generate tx sequence diagrams \(D2, mermaid, ASCII, SVG\) [\#357](https://github.com/pancsta/asyncmachine-go/pull/357)
 (@pancsta)
...
- feat\(repl\): support connecting to WebSocket servers via addr:port/path [\#355](https://github.com/pancsta/asyncmachine-go/pull/355)
 (@pancsta)
- feat\(am-relay\): add listening on TCP via WebSockets [\#354](https://github.com/pancsta/asyncmachine-go/pull/354)
 (@pancsta)
