...
<img width="354" height="154" alt="ss-2026-07-04-16-08-52" src="https://github.com/user-attachments/assets/e48992c0-c52e-48fe-9401-6854c9b2b16d" />




### feat: release v0.19.2

PR: [\#459](https://github.com/pancsta/asyncmachine-go/pull/459) (@pancsta)

The remainder of `v0.19.2` is in this PR.

### feat\(am-dbg\): release am-dbg v0.19.2

PR: [\#458](https://github.com/pancsta/asyncmachine-go/pull/458) (@pancsta)

- feat(am-dbg): add forced SSH login
- fix(am-dbg): fix reader expand panic

The remainder of `am-dbg v0.19.2` is in this PR.

### feat\(integrations\): integrate yaegi for interpreted state machines

PR: [\#457](https://github.com/pancsta/asyncmachine-go/pull/457) (@pancsta)

This is the highlight of `0.19.2`. State machines can now be extended from interpreted (dynamic) Go source code without compilation. This includes adding new states, modifying schema relations and binding handlers.

### feat\(machine\): add ActivatedAt to relate activations to machine time

PR: [\#456](https://github.com/pancsta/asyncmachine-go/pull/456) (@pancsta)

`Machine.ActivatedAt(state)` gives an inexpensive and useful reference point. Still TODO for `pkg/rpc`.

### feat\(am-gen\): drop deprecated methods

PR: [\#455](https://github.com/pancsta/asyncmachine-go/pull/455) (@pancsta)

Package-level functions will be removed in `v0.20`.

### fix\(machine\): validate empty state names

PR: [\#454](https://github.com/pancsta/asyncmachine-go/pull/454) (@pancsta)

_No PR description provided._

### feat\(machine\): add WhenTimeSum to wait for machine time

PR: [\#453](https://github.com/pancsta/asyncmachine-go/pull/453) (@pancsta)

Helps with heartbeats and queue control. Already implemented for `pkg/rpc`.

### feat\(am-dbg\): add cancellation reasons to Log Reader

PR: [\#452](https://github.com/pancsta/asyncmachine-go/pull/452) (@pancsta)

Transition cancelation causes are now listed in the reader. It's also ready for partial acceptance #412 and already showing per-state causes for Auto states.

<img width="354" height="154" alt="ss-2026-07-04-16-08-52" src="https://github.com/user-attachments/assets/80dc6b31-42e2-4965-84e0-ccd569f08556" />
<img width="351" height="108" alt="ss-2026-07-04-15-45-15" src="https://github.com/user-attachments/assets/1a64e65f-a6d3-4b25-8cd0-b611e2e1845f" />

### fix\(am-dbg\): fix diagram reconn panic when no machine selected

PR: [\#450](https://github.com/pancsta/asyncmachine-go/pull/450) (@pancsta)
...
PR: [\#431](https://github.com/pancsta/asyncmachine-go/pull/431) (@pancsta)
...
The highlight of this release is AI support.

<img width="924" height="794" alt="ss-2026-05-10-19-26-39" src="https://github.com/user-attachments/assets/8664ce72-c15d-44d8-94dd-4313f0ac7dc5" />
...
<img width="731" height="940" alt="ss-2026-05-03-16-01-14" src="https://github.com/user-attachments/assets/8a1676f0-748f-4909-90de-3d3ae1e04b17" />
...
### feat: release v0.18.2

PR: [\#376](https://github.com/pancsta/asyncmachine-go/pull/376) (@pancsta)

The remainder of `v0.18.2` is in this PR.
...
### feat\(relay\): add listening on TCP via WebSockets
...
## [v0.17.1](https://github.com/pancsta/asyncmachine-go/releases/tag/v0.17.1) (2026-01-18)

The highlight of this release is a better REPL.



### feat: release v0.17.1

PR: [\#345](https://github.com/pancsta/asyncmachine-go/pull/345) (@pancsta)

All the remainder of `v0.17.1` is here.
...
PR: [\#335](https://github.com/pancsta/asyncmachine-go/pull/335) (@pancsta)

All the remainder of `v0.17.0` is in this PR.
...
## [v0.15.1](https://github.com/pancsta/asyncmachine-go/releases/tag/v0.15.1) (2025-10-01)
...
PR: [\#290](https://github.com/pancsta/asyncmachine-go/pull/290) (@pancsta)
...
## [v0.10.2](https://github.com/pancsta/asyncmachine-go/releases/tag/v0.10.2) (2025-02-26)
...
## [v0.10.0](https://github.com/pancsta/asyncmachine-go/releases/tag/v0.10.0) (2025-01-16)



### feat: release v0.10 reminders

PR: [\#211](https://github.com/pancsta/asyncmachine-go/pull/211) (@pancsta)

- fix for partial auto states
- readmes
- changelogs
- mermaids
- test loop script
...
## [v0.9.1](https://github.com/pancsta/asyncmachine-go/releases/tag/v0.9.1) (2025-01-16)
...
## [v0.7.1](https://github.com/pancsta/asyncmachine-go/releases/tag/v0.7.1) (2024-12-14)
...
### feat: add states file v2 format
...
PR: [\#66](https://github.com/pancsta/asyncmachine-go/pull/66) (@pancsta)
...
## [v0.5.0](https://github.com/pancsta/asyncmachine-go/releases/tag/v0.5.0) (2024-06-26)
